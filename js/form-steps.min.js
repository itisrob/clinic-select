function initFormSteps(){
  ...
  steps.forEach((step)=>{
    ...
    if(prev)prev.addEventListener('click',(ev)=>{ev.preventDefault();if(current>0&&!isAnimating){isAnimating=true;steps[current].classList.add('_step-exiting-back');setTimeout(()=>{current--;show('back');save();isAnimating=false;},290);}});
